...
from processing import load_dkt_dataset
...
parser.add_argument('--data-file', type=str, default=r'MainTable.csv', help='Name of input data file.')
...
parser.add_argument('--graph-type', type=str, default='VAE', help='The type of latent concept graph.')
...
kc_id_path = r"C:\Users\admin0109\Desktop\GKT-master\data\kc_text.xlsx"
qt_kc_path = r"C:\Users\admin0109\Desktop\GKT-master\data\qt_kc_onehot.xlsx"

concept_num, graph, train_loader, valid_loader, test_loader, qt_one_hot_matrix = load_dkt_dataset(dataset_path, kc_id_path, qt_kc_path, args.batch_size, args.graph_type, dkt_graph_path=dkt_graph_path,
...
if args.model == 'GKT':
    ...
    model = GKT(concept_num, args.hid_dim, args.emb_dim, args.edge_types, args.graph_type,qt_one_hot_matrix,graph=graph, graph_model=graph_model,
