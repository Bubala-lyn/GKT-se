...
concept_num, train_loader, valid_loader, test_loader, qt_one_hot_matrix = load_dkt_dataset(dataset_path, kc_id_path, qt_kc_path, args.batch_size,
...
model = GKT(concept_num, args.hid_dim, args.emb_dim, args.edge_types, qt_one_hot_matrix, graph_model=graph_model,
